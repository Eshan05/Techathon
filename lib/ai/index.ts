...
export const CHAT_PROFILES = {
  ...
  "kisan-vakil": {
    ...
    system: [
      ...
      "- If you are not confident answering in the requested language, say that immediately and offer the best supported language instead of failing or hiding uncertainty.",
...
export function getChatModel(
  profile: Pick<ChatProfile, "provider" | "modelId">
): LanguageModel {
