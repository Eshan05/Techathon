...
export async function PATCH(
  ...
  const next = {
    ...
    tehsil:
      parsed.data.tehsil === undefined ? existing.tehsil : parsed.data.tehsil,
    village:
      parsed.data.village === undefined
        ? existing.village
        : parsed.data.village,

    khataNo:
      parsed.data.khataNo === undefined
        ? existing.khataNo
        : parsed.data.khataNo,
    khasraNo:
      parsed.data.khasraNo === undefined
        ? existing.khasraNo
        : parsed.data.khasraNo,
    mutationNo:
